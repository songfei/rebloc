...
//}
//
//class StartStreamOfIncrementsAction extends ReduxAction {}
//
...
//}
//
//class LogNameAction extends ReduxAction {
...
//
//  @override
//  Stream<WareContext<ListAppState>> applyMiddleware(Stream<WareContext<ListAppState>> input) {
//    input.listen((context) {
//      if (context.action is StartStreamOfIncrementsAction) {
//        _timer?.cancel();
//        _timer = Timer.periodic(Duration(seconds: 3), (_) => context.dispatcher(IncrementAction(_names[_rng.nextInt(_names.length)])));
//      }
//    });
//
//    return input;
...
//
//  @override
//  Stream<Accumulator<ListAppState>> applyReducer(Stream<Accumulator<ListAppState>> input) {
...
//
//  @override
//  Stream<WareContext<ListAppState>> applyAfterware(Stream<WareContext<ListAppState>> input) {
//    return input;
//  }
//
//  @override
...
//
//  @override
//  FutureOr<ReduxAction> afterware(DispatchFunction dispatcher, ListAppState state, ReduxAction action) {
//    if (state != lastState) {
...
//          converter: (state) => NameListViewModel(state.namesAndCounts.keys.toList()),
//          builder: (context, dispatcher, viewModel) {
